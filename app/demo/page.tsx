...
export default function DemoPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Navigation Bar */}
      <nav className="fixed top-0 left-0 right-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 z-30">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="text-sm text-gray-500 dark:text-gray-400">
            Interactive Demo - Hold Alt to activate Lens Mode
          </div>
        </div>
      </nav>

      {/* PDF-style container */}
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 shadow-2xl min-h-screen mt-16">
        {/* PDF Header */}
