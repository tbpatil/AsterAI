  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-2xl min-h-screen">
        {/* PDF Header */}
        <div className="px-12 pt-16 pb-8 border-b border-gray-200">
        ...
        {/* PDF Content */}
        <div className="px-12 py-8 space-y-8 text-black">
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-black border-b border-gray-300 pb-2">
              Abstract
            </h2>
